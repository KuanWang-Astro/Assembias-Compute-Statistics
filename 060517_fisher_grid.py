...
output_names = ('ngals','Pcic','ggl','vpf','wprp','param')
...
def main(model_gen_func, params_usecols, output_fname):
    global model
    ...
    for i in params_usecols:
        for j in range(5):
            params[1000*i+100*j:1000*i+100*j+100,i] -= 0.01*(j+1)
            params[1000*i+100*j+500:1000*i+100*i+600,i] += 0.01*(j+1)
...
if __name__ == '__main__':
    main(decorated_hod_model, range(7), '060517_w')
    print 
