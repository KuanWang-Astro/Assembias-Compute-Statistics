...
if __name__ == '__main__':
    main(decorated_hod_model, '../ABMCMCfiles/corr1_wp20.0.abfit.covar.chain', range(7), '062717_bolplanck_w')
    print 'w_1_20 done'
    main(standard_hod_model, '../ABMCMCfiles/corr1_wp20.0.covar.chain', range(5), '062717_bolplanck_wo')
    print 'wo_1_20 done'
