...
def main(model_gen_func, params_fname, params_usecols, output_fname):
    ...
    with Pool(nproc) as pool:
        halocat = CachedHaloCatalog(simname = 'bolshoi', version_name = 'halotools_v0p4',redshift = 0, \
...
if __name__ == '__main__':
    main(decorated_hod_model, '../ABMCMCfiles/corr1_wp20.0.abfit.covar.chain', range(7), '070517_bolshoi_w')
    print 'w_1_20 done'
    main(standard_hod_model, '../ABMCMCfiles/corr1_wp20.0.covar.chain', range(5), '070517_bolshoi_wo')
    print 'wo_1_20 done'
