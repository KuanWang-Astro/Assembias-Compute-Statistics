...
def main(model_gen_func, params_fname, params_usecols, output_fname):
    ...
    params = params[np.random.choice(len(params), 1)]*np.ones((nparams,len(params[0])))
...
if __name__ == '__main__':
    main(decorated_hod_model, '../ABMCMCfiles/corr1_wp20.0.abfit.covar.chain', range(7), '070117_consuelo_reals_w')
    print 'w_1_20 done'
    main(standard_hod_model, '../ABMCMCfiles/corr1_wp20.0.covar.chain', range(5), '070117_consuelo_reals_wo')
    print 'wo_1_20 done'
