...
if __name__ == '__main__':
    main(decorated_hod_model, '../ABMCMCfiles/corr1_wp20.0.abfit.covar.chain', range(7), '061917_consuelo_w')
    print 'w_1_20 done'
    main(standard_hod_model, '../ABMCMCfiles/corr1_wp20.0.covar.chain', range(5), '061917_consuelo_wo')
    print 'wo_1_20 done'
