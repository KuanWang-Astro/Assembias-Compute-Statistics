...
if __name__ == '__main__':
    main(decorated_hod_model, '../ABMCMCfiles/corr1_wp20.5.abfit.covar.chain', range(7), '070817_bolplanck_205_w')
    print 'w_1_20 done'
    main(standard_hod_model, '../ABMCMCfiles/corr1_wp20.5.covar.chain', range(5), '070817_bolplanck_205_wo')
    print 'wo_1_20 done'
